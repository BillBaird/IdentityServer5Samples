...
namespace BlazorServer.BffServiceOverrides
{
    ...
    /// </summary>
    public class CustomBackchannelLogoutService : IBackchannelLogoutService
    {
        ...
        private readonly ILogger<CustomBackchannelLogoutService> _logger;
