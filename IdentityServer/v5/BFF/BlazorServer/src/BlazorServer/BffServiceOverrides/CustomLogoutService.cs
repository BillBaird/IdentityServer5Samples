...
namespace BlazorServer.BffServiceOverrides
{
    ...
    /// </summary>
    public class CustomLogoutService : ILogoutService
    {
        private readonly BffOptions _options;
        private readonly IAuthenticationSchemeProvider _schemes;
        private readonly ILogger<CustomLogoutService> _logger;
        ...
        public CustomLogoutService(BffOptions options, 
            IAuthenticationSchemeProvider authenticationSchemeProvider,
            ILogger<CustomLogoutService> logger)
        {
            _options = options;
